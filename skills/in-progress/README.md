...
- **[sitrep](./sitrep/SKILL.md)** — Dispatch a subagent to build a visual sitrep of the work in flight — mission, situation, next move — as a self-contained HTML page that opens in the browser. Briefed from the working agent's memory. User-invoked.
